...
public class DotsView extends View {
    ...
    private static final int COLOR_1 = Color.parseColor("#E91E63");
    private static final int COLOR_2 = Color.parseColor("#D81B60");
    private static final int COLOR_3 = Color.parseColor("#C2185B");
    private static final int COLOR_4 = Color.parseColor("#AD1457");
