...
public class CircleView extends View {
    private static final int START_COLOR = Color.parseColor("#FF4081");
    private static final int END_COLOR = Color.parseColor("#F50057");
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        tempCanvas.drawColor(Color.parseColor("#E91E63"), PorterDuff.Mode.CLEAR);
